    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 py-8 max-w-4xl">
        ...
        <section className="mb-8">
          ...
          <div className="mb-6">
            ...
            <ul className="list-disc pl-6 space-y-1 text-muted-foreground">
              {(t('legal.privacy.section2.subsection1.list', { returnObjects: true }) as string[]).map((item, i) => (
                <li key={i}>{item}</li>
              ))}
            </ul>
          </div>
          ...
          <div className="mb-6">
            ...
            <ul className="list-disc pl-6 space-y-1 text-muted-foreground">
               {(t('legal.privacy.section2.subsection2.list', { returnObjects: true }) as string[]).map((item, i) => (
                <li key={i}>{item}</li>
              ))}
            </ul>
          </div>
          ...
          <div className="mb-6">
            ...
            <ul className="list-disc pl-6 mb-2 space-y-1 text-muted-foreground">
               {(t('legal.privacy.section2.subsection5.list', { returnObjects: true }) as string[]).map((item, i) => (
                <li key={i}>{item}</li>
              ))}
            </ul>
            <p className="text-muted-foreground">
            ...
            <table className="w-full border-collapse border border-border">
              <thead>
                <tr className="bg-muted">
                  {(t('legal.privacy.section3.table.headers', { returnObjects: true }) as string[]).map((header, i) => (
                    <th key={i} className="border border-border p-2 text-left">{header}</th>
                  ))}
                </tr>
              </thead>
              <tbody>
                {(t('legal.privacy.section3.table.rows', { returnObjects: true }) as string[][]).map((row, i) => (
                  <tr key={i}>
                    {row.map((cell, j) => (
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 mb-2 space-y-1 text-muted-foreground">
             {(t('legal.privacy.section5.list', { returnObjects: true }) as string[]).map((item, i) => (
                <li key={i}>{item}</li>
              ))}
          </ul>
          <p className="text-muted-foreground">
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 mb-4 space-y-1 text-muted-foreground">
             {(t('legal.privacy.section7.list', { returnObjects: true }) as string[]).map((item, i) => (
                <li key={i}>{item}</li>
              ))}
          </ul>
          <p className="mb-2 text-muted-foreground">
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 mb-4 space-y-1 text-muted-foreground">
             {(t('legal.privacy.section9.list', { returnObjects: true }) as string[]).map((item, i) => (
                <li key={i}>{item}</li>
              ))}
          </ul>
          <p className="text-muted-foreground">
